  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-x-2 bottom-2 top-16 sm:inset-x-auto sm:right-6 sm:top-24 sm:bottom-24 sm:w-80 bg-white/80 backdrop-blur-2xl border border-gray-200/50 rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col overflow-hidden z-40"
      >
